    ...
    <div className="animated-gradient-bg text-black py-16 px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-28 items-center gap-12">
          ...
          <div className="lg:pl-14">
            ...
            <p className="font-sans text-lg lg:text-xl mb-5 lg:mb-8 text-justify">
              Siap melayani dengan berpengalaman untuk seluruh klien dari berbagai daerah. Kami melayani secara online dan tatap muka langsung.
            </p>
          </div>
      ...
      <div className="mt-0 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { title: "Berkualitas", description: "Kenayasite menghasilkan website professional berstandard Internasional berkualitas tinggi dengan fokus pada interaktif, keahlian, dan kepuasan klien.", icon: kualitas },
            { title: "Profesional", description: "Di Kenayasite, kami menjamin kualitas maintenence yang profesional, didukung oleh tim ahli yang berkomitmen untuk memenuhi kebutuhan klien dengan tepat dan efisien.", icon: profesional },
            { title: "Inovatif", description: "Kenayasite mengedepankan inovasi dalam setiap fitur website, menciptakan solusi unik yang memperkuat identitas dan visi merek klien.", icon: kreatif },
            { title: "Totalitas", description: "Di Kenayasite, kami berkomitmen pada totalitas layanan website, memastikan setiap detail dikerjakan dengan dedikasi penuh untuk mencapai hasil terbaik bagi klien.", icon: totalitas },
            { title: "On Time", description: "Kenayasite selalu mengutamakan penyelesaian website tepat waktu, memastikan kepuasan klien tanpa mengorbankan kualitas.", icon: ontime },
            { title: "Fast Response", description: "Kenayasite memberikan layanan chat dengan fast response, siap merespon kebutuhan klien dengan cepat dan efisien dalam batas waktu jam kerja.", icon: fastrespon }
          ].map((item) => (
            <div key={item.title} className="border border-[#7b50c2] bg-[#E5F6FF] text-[#1D2B50] hover:bg-[#bbc6f798] hover:text-black p-6 rounded-lg flex flex-col items-center justify-center h-58 shadow-lg transition-transform hover:scale-105">
